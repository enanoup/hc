...
require './PHPMailer/src/SMTP.php';
    ...
    $validate = false;
        ...
        if ($nombre != "" && $email != "" && $whatsapp != "" && $servicio != "" && $mensaje != "") {
            ...
            $solucion_message = "COCA CONSULTORES WEBSITE";
            $msg = '
        ...
        <body>
            ...
            <p>Se han puesto en contacto con COCA CONSULTORES utilizando el formulario de la página web.</p>
  ...
  if ( $validate ) {
    ...
    // Se tiene que crear un correo de contacto que servira para hacer los envíos
        ...
        $mail->CharSet = 'UTF-8';
        $mail->setFrom('no-reply@rocketcodeone.com', 'Solicitud desde cocaconsultores.com');
        ...
        $mail->Subject = $nombre.' ha contactado a COCA CONSULTORES';
        $mail->isHTML(TRUE);
        $mail->Body = $msg;
        $mail->isSMTP();
